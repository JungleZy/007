            ...
            <div class="box">
              <div class="chart overflow-auto">
                ...
                <div class="totalTable" v-show="showChart=='total'">
                  ...
                  <template v-if="scoreData.ruleContent&&scoreData.deductInfo">
                    <div class="row" >
                      <div class="item lab full">码率</div>
                      <div class="item">--</div>
                      <div class="item">--</div>
              ...
              <div class="keyBox" v-if="scoreData.messageBody">
                <template v-for="(key, index) in scoreData.messageBody[scoreData.currPage-1]">
                  <div v-if="key.moresKey != '#'&&index<100"
                       :class="{key: true,
                                error: successResolver[scoreData.currPage-1]&&successResolver[scoreData.currPage-1].resolverMessage[index] &&
                    ...
                    <div class="keyErr"
                      ...
                      <div class="box">
                        <div class="text" :style="{fontSize: key.patKeys.join('')==''?'15px':'16px'}">
                          {{ successResolver[scoreData.currPage-1].resolverMessage[index].replace(/I/g,'#') }}
                          {{successResolver[scoreData.currPage-1].moreObj[index+1]?','+successResolver[scoreData.currPage-1].moreObj[index+1].replace(/I/g,'#'):''}}
                        </div>
                      </div>
                    </div>
                    <div class="keyOmis" v-if="!successResolver[scoreData.currPage-1] || !successResolver[scoreData.currPage-1].resolverMessage[index] || successResolver[scoreData.currPage-1].resolverMessage[index]==''">
                      <div class="box">
