...
<style scoped>
  .cool .loginbg {
    background: url('../../../../assets/LJ/login/staticBG-hj.png');
  }
  .loginbg {
    background: url('../../../../assets/LJ/login/staticBG-hj.png');
  }
  ...
  .loginIpt {
    background: url('../../../../assets/LJ/login/login-mask.png') no-repeat;
    background-size: 100% 100%;
  }

  /*.ckBox .ant-checkbox-wrapper .ant-checkbox-checked .ant-checkbox-inner {*/
  /*  background: url('../../../../assets/LJ/login/ico-checkbox-checked-bg.png') !important;*/
  /*}*/
  ...
  .line {
    background: url('../../../../assets/LJ/login/line.png');
    height: 32px;
    width: 100%;
    max-width: 1187px;
    position: relative;
  ...
  .lineLight {
    position: absolute;
    top: 32px;
    background: url('../../../../assets/LJ/login/line-l.png');
    width: 186px;
    height: 11px;
    left: 35%;
    opacity: 0;
  ...
  .bg {
    background-image: url('../../../../assets/LJ/login/inputBG.png');
    background-size: 100% 100%;
    padding: 0px 15px;
    transition: all 1s;
    width: 406px;
