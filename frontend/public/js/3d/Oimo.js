...
!(function (t, i) {
  ...
  Object.assign(V.prototype, {
    ...
    calcEnd: function () {
      this.setTime(2),
        ...
        (this.updateTime =
          this.totalTime -
          (this.broadPhaseTime + this.narrowPhaseTime + this.solvingTime)),
    ...
    show: function () {
      return [
        ...
        'broadphase &nbsp;' +
          g.fix(this.broadPhaseTime) +
          ' | ' +
          g.fix(this.MaxBroadPhaseTime) +
          '<br>',
        'narrowphase ' +
          g.fix(this.narrowPhaseTime) +
          ' | ' +
          g.fix(this.MaxNarrowPhaseTime) +
          '<br>',
        'solving &nbsp;&nbsp;&nbsp;&nbsp;' +
          g.fix(this.solvingTime) +
          ' | ' +
          g.fix(this.MaxSolvingTime) +
          '<br>',
        'total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
          g.fix(this.totalTime) +
          ' | ' +
          g.fix(this.MaxTotalTime) +
          '<br>',
        'updating &nbsp;&nbsp;&nbsp;' +
          g.fix(this.updateTime) +
          ' | ' +
          g.fix(this.MaxUpdateTime) +
          '<br>'
      ].join('\n')
    },
    toArray: function () {
    ...
    Object.assign(L.prototype, {
      ...
      addVectors: function (t, i) {
        return (
          (this.x = t.x + i.x), (this.y = t.y + i.y), (this.z = t.z + i.z), this
        )
      },
      addEqual: function (t) {
      ...
      addScaledVector: function (t, i) {
        return (
          (this.x += t.x * i), (this.y += t.y * i), (this.z += t.z * i), this
        )
      },
    ...
    Object.assign(P.prototype, {
      ...
      transpose: function (t) {
        if (void 0 !== t) {
          var i = t.elements
          return (
            this.set(i[0], i[3], i[6], i[1], i[4], i[7], i[2], i[5], i[8]), this
          )
        }
        var s = this.elements,
          h = s[1],
      ...
      determinant: function () {
        var t = this.elements,
          ...
          l = t[8]
        return (
          i * a * l - i * o * r - s * e * l + s * o * n + h * e * r - h * a * n
        )
      },
      fromArray: function (t, i) {
        void 0 === i && (i = 0)
    ...
    Object.assign(T.prototype, {
      ...
      copy: function (t, i) {
        var s = i || 0,
          h = t.elements
        return (
          this.set(h[0] - s, h[3] + s, h[1] - s, h[4] + s, h[2] - s, h[5] + s),
          this
        )
      },
  ...
  function H(t, i, s) {
    ...
    var h = new P().setQuat(
      new S().setFromUnitVectors(this.localAxis1, this.localAxis2)
    )
  ...
  function tt(t) {
    ...
    if (i > -1 && i < 1)
      ...
      this.localAngle1.tangent(this.localAxis1).normalize(),
        (this.localAngle2 = this.localAngle1.clone().applyMatrix3(s, !0))
    }
    ;(this.ax1 = new L()),
      (this.ax2 = new L()),
      (this.an1 = new L()),
  ...
  function ot() {
    ;(this.body1 = null),
      (this.body2 = null),
      (this.numPoints = 0),
      (this.points = [new at(), new at(), new at(), new at()])
  }
  function nt() {
    ;(this.nor = new L()),
      (this.tan = new L()),
  ...
  Object.assign(j.prototype, {
    ...
    (C.prototype = Object.assign(Object.create(j.prototype), {
      ...
      calculateMassInfo: function (t) {
        ...
        ;(t.mass = i),
          t.inertia.set(
            i *
              (this.height * this.height + this.depth * this.depth) *
              (1 / 12),
            0,
            0,
            0,
    ...
    (_.prototype = Object.assign(Object.create(U.prototype), {
      ...
      getPosition: function () {
        return [
          new L().scale(this.anchorPoint1, this.scale),
          new L().scale(this.anchorPoint2, this.scale)
        ]
      }
    })),
    Object.assign(J.prototype, {
      ...
      preSolve: function (t, i) {
        ...
        ;(a[0] +=
          s[4] * this.r1z * this.r1z -
          (s[7] + s[5]) * this.r1y * this.r1z +
          s[8] * this.r1y * this.r1y),
          (a[1] +=
            (s[6] * this.r1y + s[5] * this.r1x) * this.r1z -
            s[3] * this.r1z * this.r1z -
            s[8] * this.r1x * this.r1y),
          (a[2] +=
            (s[3] * this.r1y - s[4] * this.r1x) * this.r1z -
            s[6] * this.r1y * this.r1y +
            s[7] * this.r1x * this.r1y),
          (a[3] +=
            (s[2] * this.r1y + s[7] * this.r1x) * this.r1z -
            s[1] * this.r1z * this.r1z -
            s[8] * this.r1x * this.r1y),
          (a[4] +=
            s[0] * this.r1z * this.r1z -
            (s[6] + s[2]) * this.r1x * this.r1z +
            s[8] * this.r1x * this.r1x),
          (a[5] +=
            (s[1] * this.r1x - s[0] * this.r1y) * this.r1z -
            s[7] * this.r1x * this.r1x +
            s[6] * this.r1x * this.r1y),
          (a[6] +=
            (s[1] * this.r1y - s[4] * this.r1x) * this.r1z -
            s[2] * this.r1y * this.r1y +
            s[5] * this.r1x * this.r1y),
          (a[7] +=
            (s[3] * this.r1x - s[0] * this.r1y) * this.r1z -
            s[5] * this.r1x * this.r1x +
            s[2] * this.r1x * this.r1y),
          (a[8] +=
            s[0] * this.r1y * this.r1y -
            (s[3] + s[1]) * this.r1x * this.r1y +
            s[4] * this.r1x * this.r1x),
          (a[0] +=
            h[4] * this.r2z * this.r2z -
            (h[7] + h[5]) * this.r2y * this.r2z +
            h[8] * this.r2y * this.r2y),
          (a[1] +=
            (h[6] * this.r2y + h[5] * this.r2x) * this.r2z -
            h[3] * this.r2z * this.r2z -
            h[8] * this.r2x * this.r2y),
          (a[2] +=
            (h[3] * this.r2y - h[4] * this.r2x) * this.r2z -
            h[6] * this.r2y * this.r2y +
            h[7] * this.r2x * this.r2y),
          (a[3] +=
            (h[2] * this.r2y + h[7] * this.r2x) * this.r2z -
            h[1] * this.r2z * this.r2z -
            h[8] * this.r2x * this.r2y),
          (a[4] +=
            h[0] * this.r2z * this.r2z -
            (h[6] + h[2]) * this.r2x * this.r2z +
            h[8] * this.r2x * this.r2x),
          (a[5] +=
            (h[1] * this.r2x - h[0] * this.r2y) * this.r2z -
            h[7] * this.r2x * this.r2x +
            h[6] * this.r2x * this.r2y),
          (a[6] +=
            (h[1] * this.r2y - h[4] * this.r2x) * this.r2z -
            h[2] * this.r2y * this.r2y +
            h[5] * this.r2x * this.r2y),
          (a[7] +=
            (h[3] * this.r2x - h[0] * this.r2y) * this.r2z -
            h[5] * this.r2x * this.r2x +
            h[2] * this.r2x * this.r2y),
          (a[8] +=
            h[0] * this.r2y * this.r2y -
            (h[3] + h[1]) * this.r2x * this.r2y +
            h[4] * this.r2x * this.r2x)
        var o =
          1 /
          (a[0] * (a[4] * a[8] - a[7] * a[5]) +
            a[3] * (a[7] * a[2] - a[1] * a[8]) +
    ...
    Object.assign(W.prototype, {
      ...
      preSolve: function (t, i) {
        ...
        c
          ? (this.lowerLimit1 == this.upperLimit1
              ? (0 != this.limitState1 &&
                  ((this.limitState1 = 0), (this.limitImpulse1 = 0)),
                (this.limitVelocity1 = this.lowerLimit1 - u))
              : u < this.lowerLimit1
              ? (-1 != this.limitState1 &&
                  ((this.limitState1 = -1), (this.limitImpulse1 = 0)),
                (this.limitVelocity1 = this.lowerLimit1 - u))
              : u > this.upperLimit1
              ? (1 != this.limitState1 &&
                  ((this.limitState1 = 1), (this.limitImpulse1 = 0)),
        ...
        m
          ? (this.lowerLimit2 == this.upperLimit2
              ? (0 != this.limitState2 &&
                  ((this.limitState2 = 0), (this.limitImpulse2 = 0)),
                (this.limitVelocity2 = this.lowerLimit2 - y))
              : y < this.lowerLimit2
              ? (-1 != this.limitState2 &&
                  ((this.limitState2 = -1), (this.limitImpulse2 = 0)),
                (this.limitVelocity2 = this.lowerLimit2 - y))
              : y > this.upperLimit2
              ? (1 != this.limitState2 &&
                  ((this.limitState2 = 1), (this.limitImpulse2 = 0)),
        ...
        if (
          (p
            ? (this.lowerLimit3 == this.upperLimit3
                ? (0 != this.limitState3 &&
                    ((this.limitState3 = 0), (this.limitImpulse3 = 0)),
                  (this.limitVelocity3 = this.lowerLimit3 - x))
                : x < this.lowerLimit3
                ? (-1 != this.limitState3 &&
                    ((this.limitState3 = -1), (this.limitImpulse3 = 0)),
                  (this.limitVelocity3 = this.lowerLimit3 - x))
                : x > this.upperLimit3
                ? (1 != this.limitState3 &&
                    ((this.limitState3 = 1), (this.limitImpulse3 = 0)),
        ...
        r && 2 != this.limitState2
          ? ((b =
              i /
              ((f = (d = 6.2831853 * a) * d * t) +
                2 * this.limitMotor2.dampingRatio * d)),
          ...
          l && 2 != this.limitState3
            ? ((b =
                i /
                ((f = (d = 6.2831853 * o) * d * t) +
                  2 * this.limitMotor3.dampingRatio * d)),
      ...
      solve_: function () {
        ...
        var h =
            t * this.ax1 + i * this.ay1 + s * this.az1 - this.limitVelocity1,
      ...
      solve: function () {
        ...
        ;(this.limitImpulse1 += x),
          (this.limitImpulse2 += d),
          (this.limitImpulse3 += f)
        var b,
          v = 0
        switch (
          ((2 == this.limitState1 ||
        ...
        ;(this.limitImpulse1 = x + p),
          (this.limitImpulse2 = d + u),
          (this.limitImpulse3 = f + y)
        var z = l + x,
          N = c + d,
          k = m + f
        ;(this.a1.x += z * this.a1x1 + N * this.a1x2 + k * this.a1x3),
    ...
    (H.prototype = Object.assign(Object.create(_.prototype), {
      ...
      preSolve: function (t, i) {
        ...
        this.tmp.crossVectors(this.an1, this.an2),
          g.dotVectors(this.nor, this.tmp) < 0
            ? (this.limitMotor.angle = -s)
            : (this.limitMotor.angle = s),
    ...
    Object.assign(X.prototype, {
      ...
      preSolve: function (t, i) {
        ...
        ;((l && n > 20) || n < -20) && (l = !1),
          this.lowerLimit <= this.upperLimit
            ? (this.lowerLimit == this.upperLimit
                ? (0 != this.limitState &&
                    ((this.limitState = 0), (this.limitImpulse = 0)),
                  (this.limitVelocity = this.lowerLimit - n),
                  l || (n = this.lowerLimit))
                : n < this.lowerLimit
                ? (-1 != this.limitState &&
                    ((this.limitState = -1), (this.limitImpulse = 0)),
                  (this.limitVelocity = this.lowerLimit - n),
                  l || (n = this.lowerLimit))
                : n > this.upperLimit
                ? (1 != this.limitState &&
      ...
      solve: function () {
        ...
        if (2 != this.limitState) {
          i =
            (s - this.limitVelocity - this.limitImpulse * this.cfm) *
            this.invDenom
    ...
    Object.assign(Z.prototype, {
      ...
      preSolve: function (t, i) {
        ...
        ;(this.ii1 = this.i1.clone()),
          ...
          (s =
            1 /
            ((e = new P().add(this.ii1, this.ii2).elements)[0] *
              (e[4] * e[8] - e[7] * e[5]) +
              e[3] * (e[7] * e[2] - e[1] * e[8]) +
              e[6] * (e[1] * e[5] - e[4] * e[2]))),
          (this.dd = new P()
    ...
    Object.assign(K.prototype, {
      ...
      preSolve: function (t, i) {
        ...
        if (
          ((this.k00 =
            (this.ax1 * this.ax1 + this.ay1 * this.ay1 + this.az1 * this.az1) *
            M),
          (this.k01 =
            (this.ax1 * this.ax2 + this.ay1 * this.ay2 + this.az1 * this.az2) *
            M),
          (this.k02 =
            (this.ax1 * this.ax3 + this.ay1 * this.ay3 + this.az1 * this.az3) *
            M),
          (this.k10 =
            (this.ax2 * this.ax1 + this.ay2 * this.ay1 + this.az2 * this.az1) *
            M),
          (this.k11 =
            (this.ax2 * this.ax2 + this.ay2 * this.ay2 + this.az2 * this.az2) *
            M),
          (this.k12 =
            (this.ax2 * this.ax3 + this.ay2 * this.ay3 + this.az2 * this.az3) *
            M),
          (this.k20 =
            (this.ax3 * this.ax1 + this.ay3 * this.ay1 + this.az3 * this.az1) *
            M),
          (this.k21 =
            (this.ax3 * this.ax2 + this.ay3 * this.ay2 + this.az3 * this.az2) *
            M),
          (this.k22 =
            (this.ax3 * this.ax3 + this.ay3 * this.ay3 + this.az3 * this.az3) *
            M),
          (this.k00 +=
            this.t1x1 * this.a1x1 +
            this.t1y1 * this.a1y1 +
        ...
        y && 2 != this.limitState2
          ? ((V =
              i /
              ((I = (g = 6.2831853 * m) * g * t) +
                2 * this.limitMotor2.dampingRatio * g)),
          ...
          x && 2 != this.limitState3
            ? ((V =
                i /
                ((I = (g = 6.2831853 * p) * g * t) +
                  2 * this.limitMotor3.dampingRatio * g)),
      ...
      solve: function () {
        ...
        ;(this.limitImpulse1 = p + x),
          (this.limitImpulse2 = u + d),
          (this.limitImpulse3 = y + f)
        var z = l + x,
          N = c + d,
          k = m + f
    ...
    ($.prototype = Object.assign(Object.create(_.prototype), {
      ...
      preSolve: function (t, i) {
        ...
        var s = g.acosClamp(g.dotVectors(this.an1, this.an2))
        g.dotVectors(this.nor, this.tmp) < 0
          ? (this.rotationalLimitMotor.angle = -s)
          : (this.rotationalLimitMotor.angle = s),
          this.tmp.crossVectors(this.ax1, this.ax2),
          (this.r3.limitMotor2.angle = g.dotVectors(this.tan, this.tmp)),
          (this.r3.limitMotor3.angle = g.dotVectors(this.bin, this.tmp)),
    ...
    (ot.prototype = {
      ...
      addPoint: function (t, i, s, h, e, a, o, n) {
        ...
        r.position.set(t, i, s),
          r.localPoint1
            .sub(r.position, this.body1.position)
            .applyMatrix3(this.body1.rotation),
          r.localPoint2
            .sub(r.position, this.body2.position)
            .applyMatrix3(this.body2.rotation),
          (r.normalImpulse = 0),
          r.normal.set(h, e, a),
          n && r.normal.negate(),
      ...
      preSolve: function (t, i) {
        ...
        for (var h, e, a, o, n, r, l, c = this.cs, m = 0; m < this.num; m++)
          (h = this.ps[m]),
            ...
            c.tan.set(
              this.tmp.x - e * c.nor.x,
              this.tmp.y - e * c.nor.y,
              this.tmp.z - e * c.nor.z
            ),
            ...
            e > -1 && (e = 0),
            (o = this.restitution * -e) <
              (n = -(h.penetration + 0.005) * i * 0.05) && (o = n),
            (c.norTar = o),
            (c.last = m == this.num - 1),
            (c = c.next)
      },
      solve: function () {
        ...
        for (
          ...
          (e = l.norImp),
            ...
            (r =
              (a += i =
                (g.dotVectors(this.tmp, l.tan) +
                  g.dotVectors(this.tmpav2, l.tanT2) -
                  g.dotVectors(this.tmpav1, l.tanT1)) *
                l.tanDen) *
                a +
              (o += h =
                (g.dotVectors(this.tmp, l.bin) +
                  g.dotVectors(this.tmpav2, l.binT2) -
                  g.dotVectors(this.tmpav1, l.binT1)) *
                l.binDen) *
                o) >
            ...
            (h = o - s),
            this.tmp.set(
              l.tanU1.x * i + l.binU1.x * h,
              l.tanU1.y * i + l.binU1.y * h,
              l.tanU1.z * i + l.binU1.z * h
            ),
            this.tmplv1.addEqual(this.tmp),
            this.tmp.set(
              l.tanTU1.x * i + l.binTU1.x * h,
              l.tanTU1.y * i + l.binTU1.y * h,
              l.tanTU1.z * i + l.binTU1.z * h
            ),
            this.tmpav1.addEqual(this.tmp),
            this.tmp.set(
              l.tanU2.x * i + l.binU2.x * h,
              l.tanU2.y * i + l.binU2.y * h,
              l.tanU2.z * i + l.binU2.z * h
            ),
            this.tmplv2.subEqual(this.tmp),
            this.tmp.set(
              l.tanTU2.x * i + l.binTU2.x * h,
              l.tanTU2.y * i + l.binTU2.y * h,
              l.tanTU2.z * i + l.binTU2.z * h
            ),
    ...
    Object.assign(lt.prototype, {
      ...
      updateManifold: function () {
        ...
        if (0 == e)
          return (
            (this.touching = !1), (this.close = !1), void (this.dist = g.INF)
          )
        for (
          ...
          for (
            ...
            var y = (s = this.buffer[u]).lp1X - a,
              ...
              b =
                ...
                (x = s.lp2Y - l) * x +
                (d = s.lp2Z - c) * d
            f < b ? f < p && ((p = f), (m = u)) : b < p && ((p = b), (m = u)),
              p < this.dist && (this.dist = p)
          }
          if (-1 != m) {
            var v = this.buffer[m]
            ;(this.buffer[m] = this.buffer[--t]),
              (this.buffer[t] = v),
              (h.normalImpulse = v.impulse),
              (h.warmStarted = !0)
      ...
      attach: function (t, i) {
        ;(this.shape1 = t),
          ...
          null != t.contactLink
            ? ((this.s1Link.next = t.contactLink).prev = this.s1Link)
            : (this.s1Link.next = null),
          (t.contactLink = this.s1Link),
          t.numContacts++,
          null != i.contactLink
            ? ((this.s2Link.next = i.contactLink).prev = this.s2Link)
    ...
    Object.assign(ct.prototype, {
      ...
      setupMass: function (t, i) {
        ...
        for (
          var h = new P(), e = new L(), a = this.shapes;
          null !== a;
          a = a.next
        ) {
        ...
        switch (this.type) {
          case 2:
            this.linearVelocity.set(0, 0, 0),
              this.angularVelocity.set(0, 0, 0),
              this.controlPos &&
                (this.position.copy(this.newPosition), (this.controlPos = !1)),
              this.controlRot &&
          ...
          case 1:
            this.isKinematic &&
              ...
              this.controlPos &&
                (this.linearVelocity
                  .subVectors(this.newPosition, this.position)
                  .multiplyScalar(1 / t),
                (this.controlPos = !1)),
              this.controlRot &&
      ...
      getAxis: function () {
        return new L(0, 1, 0)
          .applyMatrix3(this.inverseLocalInertia, !0)
          .normalize()
      },
      rotateInertia: function (t, i, s) {
        this.tmpInertia.multiplyMatrices(t, i),
          s.multiplyMatrices(this.tmpInertia, t, !0)
      },
      syncShapes: function () {
      ...
      setPosition: function (t) {
        this.newPosition.copy(t).multiplyScalar(this.invScale),
          (this.controlPos = !0),
          this.isKinematic || (this.isKinematic = !0)
      },
      ...
      setRotation: function (t) {
        ;(this.newOrientation = new S().setFromEuler(
          t.x * g.degtorad,
          t.y * g.degtorad,
          t.z * g.degtorad
        )),
      ...
      resetQuaternion: function (t) {
        this.angularVelocity.set(0, 0, 0),
          (this.orientation = new S(t.x, t.y, t.z, t.w)),
          this.awake()
      },
      resetRotation: function (t, i, s) {
        this.angularVelocity.set(0, 0, 0),
          (this.orientation = new S().setFromEuler(
            t * g.degtorad,
            i * g.degtorad,
            s * g.degtorad
          )),
    ...
    Object.assign(pt.prototype, {
      ...
      isAvailablePair: function (t, i) {
        ...
        if (
          h == e ||
          (!h.isDynamic && !e.isDynamic) ||
          0 == (t.belongsTo & i.collidesWith) ||
          0 == (i.belongsTo & t.collidesWith)
        )
          return !1
        for (
          s = h.numJoints < e.numJoints ? h.jointLink : e.jointLink;
          null !== s;
          ...
          if (
            !a.allowCollision &&
            ((a.body1 == h && a.body2 == e) || (a.body1 == e && a.body2 == h))
          )
            return !1
          s = s.next
        }
  ...
  Object.assign(yt.prototype, {
    ...
    (dt.prototype = Object.assign(Object.create(pt.prototype), {
      ...
      collectPairs: function () {
        ...
        for (this.numPairChecks = (a * (a - 1)) >> 1; h < a; )
          for (i = e[h++], t = h + 1; t < a; )
            (s = e[t++]),
              !i.aabb.intersectTest(s.aabb) &&
                this.isAvailablePair(i.shape, s.shape) &&
                this.addPair(i.shape, s.shape)
      }
    })),
    Object.assign(ft.prototype, {
      ...
      sort: function () {
        ...
        for (
          var s = !1, h = this.elements, e = 1, a = this.numElements;
          e < a;
          e++
        ) {
          var o = h[e],
        ...
        if (s) {
          ...
          for (c[0] = 0, c[1] = this.numElements - 1; t > 0; ) {
            ...
            if (u > 16) {
              ...
              for (
                o = h[y], h[y] = h[m], h[m] = o, n = o.value, e = p - 1, l = m;
                ;
    ...
    Object.assign(kt.prototype, {
        ...
        if (null != this.root) {
          for (var i, s, h = t.aabb, e = this.root; null == e.proxy; ) {
            ...
            this.aabb.combine(h, r),
              null != a.proxy
                ? (p += this.aabb.surfaceArea())
                : (p += this.aabb.surfaceArea() - r.surfaceArea())
            var u = m
            if (
              (this.aabb.combine(h, l),
              null != o.proxy
                ? (u += this.aabb.surfaceArea())
                : (u += this.aabb.surfaceArea() - l.surfaceArea()),
              p < u)
            ) {
              if (c < p) break
              e = a
      ...
      deleteLeaf: function (t) {
        if (t != this.root) {
          var i,
            s = t.parent
          if (((i = s.child1 == t ? s.child2 : s.child1), s == this.root))
            return (this.root = i), void (i.parent = null)
          var h = s.parent
          ;(i.parent = h),
            h.child1 == s ? (h.child1 = i) : (h.child2 = i),
            this.numFreeNodes < 16384 &&
              (this.freeNodes[this.numFreeNodes++] = s)
          do {
      ...
      fix: function (t) {
        var i = t.child1,
          s = t.child2
        t.aabb.combine(i.aabb, s.aabb),
          (t.height = i.height < s.height ? s.height + 1 : i.height + 1)
      }
    }),
      ...
      collide: function (t, i) {
        ...
        for (this.stack[0] = t, this.stack[1] = i; r > 0; )
          if (
            ...
            if (
              (s = e.proxy.shape) == (h = a.proxy.shape) ||
              s.aabb.intersectTest(h.aabb) ||
              !this.isAvailablePair(s, h)
            )
              continue
            this.addPair(s, h)
          } else {
            ...
            n || (!o && e.aabb.surfaceArea() > a.aabb.surfaceArea())
              ? ((this.stack[r++] = e.child1),
                (this.stack[r++] = a),
                (this.stack[r++] = e.child2),
                (this.stack[r++] = a))
              : ((this.stack[r++] = e),
                (this.stack[r++] = a.child1),
                (this.stack[r++] = e),
                (this.stack[r++] = a.child2))
          }
      }
    })),
      ...
      detectCollision: function (t, i, s) {
        ...
        if (
          ...
          N > Vi && ((Ii = N), (Vi = N), (Li = 1), (Si = o)),
            ...
            V - 0.01 > Vi &&
              !fi &&
              ((Ii = V), (Vi = V - 0.01), (Li = 6), (Si = m)),
            L - 0.01 > Vi &&
              !bi &&
              ((Ii = L), (Vi = L - 0.01), (Li = 7), (Si = p)),
            S - 0.01 > Vi &&
              !vi &&
              ((Ii = S), (Vi = S - 0.01), (Li = 8), (Si = u)),
            P - 0.01 > Vi &&
              !zi &&
              ((Ii = P), (Vi = P - 0.01), (Li = 9), (Si = y)),
            T - 0.01 > Vi &&
              !Ni &&
              ((Ii = T), (Vi = T - 0.01), (Li = 10), (Si = x)),
            A - 0.01 > Vi &&
              !ki &&
              ((Ii = A), (Vi = A - 0.01), (Li = 11), (Si = d)),
            j - 0.01 > Vi &&
              !wi &&
              ((Ii = j), (Vi = j - 0.01), (Li = 12), (Si = f)),
            C - 0.01 > Vi &&
              !Mi &&
              ((Ii = C), (Vi = C - 0.01), (Li = 13), (Si = b)),
          ...
          if (
            ...
            Si || ((Pi = -Pi), (Ti = -Ti), (Ai = -Ai)),
              ...
              (Yi = Pi * (Ki = U[3]) + Ti * (Gi = U[4]) + Ai * ($i = U[5])) >
                Zi && ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
              (Yi = Pi * (Ki = U[6]) + Ti * (Gi = U[7]) + Ai * ($i = U[8])) >
                Zi && ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
              (Yi = Pi * (Ki = U[9]) + Ti * (Gi = U[10]) + Ai * ($i = U[11])) >
                Zi && ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
              (Yi = Pi * (Ki = U[12]) + Ti * (Gi = U[13]) + Ai * ($i = U[14])) >
                Zi && ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
              (Yi = Pi * (Ki = U[15]) + Ti * (Gi = U[16]) + Ai * ($i = U[17])) >
                Zi && ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
              (Yi = Pi * (Ki = U[18]) + Ti * (Gi = U[19]) + Ai * ($i = U[20])) >
                Zi && ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
              (Yi = Pi * (Ki = U[21]) + Ti * (Gi = U[22]) + Ai * ($i = U[23])) >
                Zi && ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
              (Zi = Pi * (hs = R[0]) + Ti * (es = R[1]) + Ai * (as = R[2])),
              (Yi = Pi * (Ki = R[3]) + Ti * (Gi = R[4]) + Ai * ($i = R[5])) <
                Zi && ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
              (Yi = Pi * (Ki = R[6]) + Ti * (Gi = R[7]) + Ai * ($i = R[8])) <
                Zi && ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
              (Yi = Pi * (Ki = R[9]) + Ti * (Gi = R[10]) + Ai * ($i = R[11])) <
                Zi && ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
              (Yi = Pi * (Ki = R[12]) + Ti * (Gi = R[13]) + Ai * ($i = R[14])) <
                Zi && ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
              (Yi = Pi * (Ki = R[15]) + Ti * (Gi = R[16]) + Ai * ($i = R[17])) <
                Zi && ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
              (Yi = Pi * (Ki = R[18]) + Ti * (Gi = R[19]) + Ai * ($i = R[20])) <
                Zi && ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
              (Yi = Pi * (Ki = R[21]) + Ti * (Gi = R[22]) + Ai * ($i = R[23])) <
                Zi && ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i))
            var os =
            ...
            var ns,
              ...
              Ps = 0
            Xi
              ? ((Ss = rt * Pi + lt * Ti + ct * Ai) < Ls &&
                  ((Ls = Ss), (Ps = 0)),
                -Ss < Ls && ((Ls = -Ss), (Ps = 1)),
                (Ss = mt * Pi + pt * Ti + ut * Ai) < Ls &&
                  ((Ls = Ss), (Ps = 2)),
                -Ss < Ls && ((Ls = -Ss), (Ps = 3)),
                (Ss = yt * Pi + xt * Ti + dt * Ai) < Ls &&
                  ((Ls = Ss), (Ps = 4)),
                -Ss < Ls && ((Ls = -Ss), (Ps = 5)),
                0 == Ps
                  ? ((ns = U[0]),
                  ...
                  : 5 == Ps &&
                    ...
                    (fs = U[16]),
                    (bs = U[17])))
              : ((Ss = It * Pi + Vt * Ti + Lt * Ai) < Ls &&
                  ((Ls = Ss), (Ps = 0)),
                -Ss < Ls && ((Ls = -Ss), (Ps = 1)),
                (Ss = St * Pi + Pt * Ti + Tt * Ai) < Ls &&
                  ((Ls = Ss), (Ps = 2)),
                -Ss < Ls && ((Ls = -Ss), (Ps = 3)),
                (Ss = At * Pi + jt * Ti + Ct * Ai) < Ls &&
                  ((Ls = Ss), (Ps = 4)),
                -Ss < Ls && ((Ls = -Ss), (Ps = 5)),
                0 == Ps
                  ? ((ns = R[0]),
                      ...
                      for (Ls = this.INF, Ts = 0; Ts < vs; Ts++)
                        (this.used[Ts] = !1),
                          ...
                          (Ss =
                            ...
                            (Ms = this.clipVertices1[Ns + 2]) * Oi) < Ls &&
                            ((Ls = Ss), (Cs = Ts)),
                          Ss > Bs && ((Bs = Ss), (Ds = Ts))
                      for (
                        this.used[Cs] = !0,
                        ...
                        this.used[Ts] ||
                          ...
                          (Ss =
                            ...
                            (Ms = this.clipVertices1[Ns + 2]) * Bi) < Ls &&
                            ((Ls = Ss), (Os = Ts)),
                          Ss > Bs && ((Bs = Ss), (Es = Ts)))
                      ;(Ns = 3 * Cs),
                        (Ss =
                      ...
                      for (Ts = 0; Ts < vs; Ts++)
                        (Ns = 3 * Ts),
                          (Ss =
                            ((ks = this.clipVertices1[Ns]) - Fi) * Pi +
                            ((ws = this.clipVertices1[Ns + 1]) - qi) * Ti +
                            ((Ms = this.clipVertices1[Ns + 2]) - Ui) * Ai) <
                            0 && s.addPoint(ks, ws, Ms, Pi, Ti, Ai, Ss, js)
                  }
                }
              }
            }
    ...
    (Vt.prototype = Object.assign(Object.create(gt.prototype), {
      ...
      getSep: function (t, i, s, h, e) {
        ...
        if (
          ...
          return (
            s.set(F - I, q - V, U - S).normalize(),
            h.set(0.5 * (j + D), 0.5 * (C + E), 0.5 * (O + B)),
            !0
          )
        this.supportPointB(t, -P, -T, -A, b)
        var R = b.x,
          ...
          if (
            ...
            for (var nt = !1; ; ) {
              ...
              var ft = b.x,
                ...
                wt = -(zt * P + Nt * T + kt * A)
              if (
                (zt - et) * P + (Nt - at) * T + (kt - ot) * A <= 0.01 ||
                wt >= 0
              )
                return (
                  !!nt &&
                  (s.set(-P, -T, -A),
                  h.set(0.5 * (p + x), 0.5 * (u + d), 0.5 * (y + f)),
                  (e.x = wt),
                  !0)
                )
              ;(Nt * U - kt * q) * I +
      ...
      detectCollision: function (t, i, s) {
        ...
        if (this.getSep(h, e, a, o, n)) {
          ...
          if (
            ...
            ;(Nt = H * (hi - ot) + Q * (ei - nt) + X * (ai - rt)) <= 0 &&
              s.addPoint(hi, ei, ai, -H, -Q, -X, Nt, this.flip),
              (Nt = H * (oi - ot) + Q * (ni - nt) + X * (ri - rt)) <= 0 &&
                s.addPoint(oi, ni, ri, -H, -Q, -X, Nt, this.flip),
              (Nt = H * (li - ot) + Q * (ci - nt) + X * (mi - rt)) <= 0 &&
                s.addPoint(li, ci, mi, -H, -Q, -X, Nt, this.flip),
              (Nt = H * (pi - ot) + Q * (ui - nt) + X * (yi - rt)) <= 0 &&
                s.addPoint(pi, ui, yi, -H, -Q, -X, Nt, this.flip)
          } else {
            switch (si) {
              case 1:
                $
            ...
            if (
              ...
              (lt = q * q * 1.5 - 0.5),
                ...
                (Nt =
                  H *
                    ((bt = (Lt = bt = Lt * lt + St * ct + Pt * mt) + ot) - ht) +
                  Q * ((vt = (St = vt) + nt) - et) +
                  X * ((zt = (Pt = zt) + rt) - at)) <= 0 &&
                  ((qt =
                    Xt * (Mt = bt - Nt * H - ht) +
              ...
              if (((Ht = Z + ti), (Wt = Y + ti) < 0)) {
                ...
                Ht < 0 &&
                  ...
                  (Vt = (Jt = qt + Vt * Qt) - qt))
              if (
                ((Ht = (Z = Ct * Kt + Ot * Gt + Dt * $t) - ii),
                (Wt = (Y = Tt * Kt + At * Gt + jt * $t) - ii) > 0)
              ) {
                if (Ht > 0) return
                ;(Y =
            ...
            case 1:
              ...
              if (
                ...
                (dt = Q * Q * 1.5 - 0.5),
                  ...
                  (Lt =
                    pt *
                      ((gt = (st = gt = st * dt + ht * ft + et * bt) + l) - o) +
                    ut * ((It = (ht = It) + c) - n) +
                    yt * ((Vt = (et = Vt) + m) - r)) <= 0 &&
                    ((a =
                      (p = gt - Lt * pt - o) * p +
                  ...
                  (Tt =
                    (St =
                      (st =
                        ...
                        (p =
                          (b -=
                            (k = pt * (b - o) + ut * (v - n) + yt * (z - r)) *
                            pt) - x) +
                      (ht = n - (d -= N * ut)) * (u = (v -= k * ut) - d) +
                      (et = r - (f -= N * yt)) * (y = (z -= k * yt) - f)) *
                      St -
                    (Pt = p * p + u * u + y * y) *
                      (st * st + ht * ht + et * et - R * R)) < 0)
                )
                  break
                ;(I = (St - (Tt = g.sqrt(Tt))) / Pt) < (M = (St + Tt) / Pt) &&
                  ((a = M), (M = I), (I = a)),
                  I > 1 && (I = 1),
                  M < 0 && (M = 0),
                  (p = x + (b - x) * M),
            ...
            case 2:
              ...
              if (
                ...
                (dt = J * J * 1.5 - 0.5),
                  ...
                  (Lt =
                    pt *
                      ((gt = (st = gt = st * dt + ht * ft + et * bt) + o) - l) +
                    ut * ((It = (ht = It) + n) - c) +
                    yt * ((Vt = (et = Vt) + r) - m)) <= 0 &&
                    ((a =
                      (p = gt - Lt * pt - l) * p +
                  ...
                  (Tt =
                    (St =
                      (st =
                        ...
                        (p =
                          (b -=
                            (k = pt * (b - l) + ut * (v - c) + yt * (z - m)) *
                            pt) - x) +
                      (ht = c - (d -= N * ut)) * (u = (v -= k * ut) - d) +
                      (et = m - (f -= N * yt)) * (y = (z -= k * yt) - f)) *
                      St -
                    (Pt = p * p + u * u + y * y) *
                      (st * st + ht * ht + et * et - _ * _)) < 0)
                )
                  break
                ;(I = (St - (Tt = g.sqrt(Tt))) / Pt) < (M = (St + Tt) / Pt) &&
                  ((a = M), (M = I), (I = a)),
        ...
        V > z ? (V = z) : V < -z ? (V = -z) : (P = 1),
          ...
          7 == P
            ...
            : ((a = d + V * c[0] + L * c[3] + S * c[6]),
              (o = f + V * c[1] + L * c[4] + S * c[7]),
              (n = b + V * c[2] + L * c[5] + S * c[8]),
              (r = (w = a - m.x) * w + (M = o - m.y) * M + (I = n - m.z) * I) >
                0 &&
                r < v * v &&
                ((w *= l = 1 / (r = g.sqrt(r))),
                (M *= l),
    ...
    (jt.prototype = Object.assign(Object.create(gt.prototype), {
      ...
      detectCollision: function (t, i, s) {
        ...
        this.dix.set(l[0], l[1], l[2]),
          ...
          (e.z *= r.normal.z),
          o.set(
            g.dotVectors(this.dix, e),
            g.dotVectors(this.diy, e),
            g.dotVectors(this.diz, e)
          ),
          ...
          7 === u &&
            ...
            e.x < e.y
              ? e.x < e.z
                ? ((h = e.x - c),
                  o.x < 0
                    ? ((o.x = -c), e.copy(this.dix))
                    : ((o.x = c), e.subEqual(this.dix)))
                : ((h = e.z - p),
                  o.z < 0
                    ? ((o.z = -p), e.copy(this.diz))
                    : ((o.z = p), e.subEqual(this.diz)))
              : e.y < e.z
              ? ((h = e.y - m),
                o.y < 0
                  ? ((o.y = -m), e.copy(this.diy))
                  : ((o.y = m), e.subEqual(this.diy)))
              : ((h = e.z - p),
                o.z < 0
                  ? ((o.z = -p), e.copy(this.diz))
                  : ((o.z = p), e.subEqual(this.diz))),
    ...
    Object.assign(Ct.prototype, {
      ...
      addShape: function (t) {
        ;(t.parent && t.parent.parent) ||
          I('World', 'It is not possible to be added alone to shape world'),
      ...
      getContact: function (t, i) {
        var s, h
        ;(t = t.constructor === ct ? t.name : t),
          (i = i.constructor === ct ? i.name : i)
      ...
      callSleep: function (t) {
        return (
          !!t.allowSleep &&
          !(t.linearVelocity.lengthSq() > 0.04) &&
          !(t.angularVelocity.lengthSq() > 0.25)
        )
      },
      step: function () {
        var t = this.isStat
        ...
        for (
          var s = this.broadPhase.pairs, h = this.broadPhase.numPairs;
          h--;
          ...
          var e,
            ...
            o,
            n = s[h]
          n.shape1.id < n.shape2.id
            ? ((e = n.shape1), (a = n.shape2))
            : ((e = n.shape2), (a = n.shape1)),
        ...
        for (
          ...
          if (z.persisting || !z.shape1.aabb.intersectTest(z.shape2.aabb)) {
            var l = z.body1,
              c = z.body2
            ;((l.isDynamic && !l.sleeping) || (c.isDynamic && !c.sleeping)) &&
              z.updateManifold(),
        ...
        for (var x = this.rigidBodies; null !== x; x = x.next)
          if (!(x.addedToIsland || x.isStatic || x.sleeping))
            if (x.isLonely())
              x.isDynamic &&
                x.linearVelocity.addScaledVector(this.gravity, this.timeStep),
                this.callSleep(x)
                  ? ((x.sleepTime += this.timeStep),
                    x.sleepTime > 0.5
                      ? x.sleep()
                      : x.updatePosition(this.timeStep))
              ...
              do {
                if (
                  ...
                  for (var v = i.contactLink; null !== v; v = v.next) {
                    var z
                    if (
                      !(u = (z = v.contact).constraint).addedToIsland &&
                      z.touching
                    )
                      (this.islandConstraints[f++] = u),
                        (u.addedToIsland = !0),
                        (m = v.body).addedToIsland ||
              ...
              for (
                var k = new L().addScaledVector(this.gravity, this.timeStep),
                  w = d;
                w--;

              )
                (i = this.islandRigidBodies[w]).isDynamic &&
                  i.linearVelocity.addEqual(k)
              if (this.enableRandomizer)
                for (w = f; w--; )
                  if (0 !== w) {
                    var M =
                      (((this.randX =
                        (this.randX * this.randA + this.randB) & 2147483647) /
                        2147483648) *
                        w) |
                      0
              ...
              for (w = f; w--; )
                this.islandConstraints[w].postSolve(),
                  (this.islandConstraints[w] = null)
              var I = 10
              for (w = d; w--; )
                (i = this.islandRigidBodies[w]),
                  this.callSleep(i)
                    ? ((i.sleepTime += this.timeStep),
                      i.sleepTime < I && (I = i.sleepTime))
                    : ((i.sleepTime = 0), (I = 0))
              if (I > 0.5)
                for (w = d; w--; )
                  this.islandRigidBodies[w].sleep(),
                    (this.islandRigidBodies[w] = null)
              else
                for (w = d; w--; )
                  this.islandRigidBodies[w].updatePosition(this.timeStep),
                    (this.islandRigidBodies[w] = null)
              this.numIslands++
            }
      ...
      add: function (t) {
        var i = (t = t || {}).type || 'box'
        return (
          i.constructor === String && (i = [i]),
          'joint' === i[0].substring(0, 5)
            ? this.initJoint(i[0], t)
            : this.initBody(i, t)
        )
      },
      initBody: function (t, i) {
        ...
        for (
          var m,
            ...
            u = new ct(
              new L(a[0], a[1], a[2]),
              new S().setFromEuler(n[0], n[1], n[2])
            ),
            y = 0;
          y < t.length;
          y++
          ...
          switch (
            (void 0 !== o[(p = 3 * y)] &&
              c.relativePosition.set(o[p], o[p + 1], o[p + 2]),
            void 0 !== r[p] &&
              c.relativeRotation.setQuat(
                new S().setFromEuler(r[p], r[p + 1], r[p + 2])
              ),
            t[y])
          ) {
            case 'sphere':
      ...
      initJoint: function (t, i) {
        ...
        var u,
          y = null,
          x = null
        if (void 0 === i.body1 || void 0 === i.body2)
          return I('World', "Can't add joint if attach rigidbodys not define !")
        if (
