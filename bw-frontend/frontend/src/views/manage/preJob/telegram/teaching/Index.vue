  ...
  <div class="w-full h-full overflow-hidden layout-side" style="position:relative;">
    <div class="w-full h-full ">
      <div class="w-full h-full relative">
        <div class="absolute" style="top: 30px;right: 20px;z-index: 9;">
          <span class="posture" :class="{labelS:activeS==0}" @click="activeS=0">手键教学</span>
          <span class="posture" :class="{labelS:activeS==1}" @click="activeS=1">电子键教学</span>
        </div>
        <video controls loop :src="handkeyMp4" v-if="activeS==0" style="width: 100%;height: 100%;object-fit: fill;"></video>
        <video controls loop :src="examMp4" v-if="activeS==1" style="width: 100%;height: 100%;object-fit: fill;"></video>
      </div>
    </div>
  </div>
</template>
...
<script setup>
  ...
  import {rightLittleFinger1, rightLittleFinger2, gear, foreArm, handKey, handKeyPlay, electronicKey, electronicKeyPlay, keyboard, keyboardPlay} from "../../datagram/teaching/js/jsonData"
  // import handkeyMp4 from '../../../../../assets/HJ/mp4/handkey.mp4'
  // import examMp4 from '../../../../../assets/HJ/mp4/exam.mp4'
