> **状态：已被取代，降为历史证据。** 当前全项目评审唯一入口是
> [`2026-09-12-full-project-review.md`](2026-09-12-full-project-review.md)。
> 本文的测试基线（216）、MyISAM 表数、行号与结论只反映 **2026-09-08 当时**的状态，
> 按归档规则原样保留（见 [`../README.md`](../README.md)），不得当作当前状态依据。
