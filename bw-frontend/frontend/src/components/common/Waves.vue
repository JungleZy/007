<!--
 * @Author: your name
 * @Date: 2022-03-23 14:47:41
 * @LastEditTime: 2022-03-23 15:18:29
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \project-006-frontend\src\components\common\waves.vue
-->
<template>
  <div id="iviewBg"></div>
</template>
...
export default {
  ...
  //     container.style.bottom = `${props.top}px`;
  //
