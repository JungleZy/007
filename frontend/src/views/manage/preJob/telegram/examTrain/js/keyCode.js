...
const letterKey = {
  ...
  "G": [
    ...
    {key:'4', code: '4',coding: '24',tip: '无名指'},
    {key:'空格', code: 'enter',coding: '41',tip: '拇指'},
    {key:'FM', code: 'FM',coding: '43',tip: '中指'},
    {key:'1', code: '1',coding: '21',tip: '食指'}
  ],
  "H": [
    {key:'7', code: '7',coding: '32',tip: '食指'},
...
const electronKey = [
    ...
    [
      ...
      {key:'FM', text:'FM', _code: [1,1], code: '43'},
...
const codeInKey = {
  ...
  '43': {key:'FM', text:'FM', _code: [1,1], code: '43'},
...
export {
  numberKey,letterKey,specialKey,electronKey,fingerKey, codeInKey,codeOnKey
}