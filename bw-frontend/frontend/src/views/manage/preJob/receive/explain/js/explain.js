...
import {findReceivePointsByType,saveReceivePoints } from '../../../../../../common/api/ExplainApi'
...
export default function explain() {
   ...
   const addMainPoints=()=>{
      ...
      if (!newKnowledge.value.content||newKnowledge.value.content.length===0){
         message.warning('请添加要点内容');
         return;
      }
      ...
      saveReceivePoints(obj).then(res=>{
         if (res.code===200){
            if (newKnowledge.value.update){
