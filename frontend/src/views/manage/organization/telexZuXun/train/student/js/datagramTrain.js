...
import {
  ...
  getElectronKeyZuXunPageNumber,uploadElectronKeyZuXunPatResult,resetHandKeyZuXunTrain
...
export default function (trainData,loading,emits) {
  ...
  const textareaChange = () => {
    ...
    if (pageCodes.value[currPatKeyIndex.value - 1]) {
      pageCodes.value[currPatKeyIndex.value-1] = pageCodes.value[currPatKeyIndex-1].toUpperCase()
    }
  }
  /**
   * 切换电报纸
