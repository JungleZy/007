...
**状态:** 已落地 — `scripts/rehearse-migrations.sh:44-47` 以 `REHEARSAL_OUT_NAME` 参数化并校验目录名字符集，`:51-59` 自动定位/复制 `entity-schema.tsv`；产物在 `backend/database/rehearsal/2026-09-07-postbackfill/`，耗时写入 `docs/reviews/2026-09-07-migration-rehearsal.md:23-46`。
