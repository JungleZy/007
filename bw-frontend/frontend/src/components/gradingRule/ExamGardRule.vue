    ...
    <div class="h-full grading-list overflow-auto relative" style="width: calc(100% - 200px)">
      <div class="w-full pl-1 pr-1 layout-left-center" v-if="pickRuleIndex > -1">
        ...
        <a-row class="w-full">
          ...
          <a-col :span="2" class="layout-left-center">&nbsp;&nbsp;码/分</a-col>
    ...
    gr.getGradingRuleListByType({type: 3}).then(res => {
      if (res.code === 200) {
        res.data.forEach(d => {
          ...
          d.content.other.lessGap = d.content.other.lessGap || 0
        })
        ...
        console.log(ruleList.value[pickRuleIndex.value].content.other)
      } else {
