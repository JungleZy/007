  ...
  <div class="telexTrainBox content-mask-bg h-full w-full overflow-auto layout-left-top relative">
        ...
        <div class="stateBox">
          ...
          <div class="layout-center">
            <a-switch
              ...
              v-if="trainData.status === 1 && trainData.type === 3"
              @change="changeSwitch"
              checked-children="专注"
            ...
            <div class="basicInit" style="position: relative">
              <div class="item relative">
                ...
                <div>
                  ...
                  <div class="tags nobr">
                    {{ trainData.correctNum * 1 }}{{ trainData.type === 4 ? '个' : '组' }}
                  </div>
                </div>
              </div>
              <div class="item relative">
                ...
                <div>
                  ...
                  <div class="tags nobr">
                    {{ trainData.errorNum * 1 }}{{ trainData.type === 4 ? '个' : '组' }}
                  </div>
                </div>
              </div>
              <div class="item relative">
    ...
    >
      ...
      <div class="w-full" style="height: 100%">
        <div class="w-full h-full layout-left-top" style="overflow: auto; max-height: max-content">
          <WZTrain :message="message" :trainData="trainData" :isfocus="isfocus"></WZTrain>
        </div>
      </div>
    </div>
          ...
          <div class="dataBox">
              ...
              <div class="bottom">
                ...
                <div class="resGroup">
                  ...
                  <div class="cont">
                    ...
                    <div class="num">
                      {{ trainData.speed }}<span style="font-size: 20px">词/分</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="resRight w-full">
              <div class="resTextItem">
                ...
                &nbsp;{{ trainData.correctNum }}个
              </div>
              <div class="resTextItem">
                <div class="desc">错误字数 </div>
                &nbsp;{{ trainData.errorNum }}个
              </div>
            </div>
            <div class="splitLine"></div>
            <div class="resRight w-full">
...
<style scoped lang="less">
  ...
  :deep(.ant-input:focus, .ant-input:hover) {
