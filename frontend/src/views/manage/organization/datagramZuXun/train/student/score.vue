          ...
          <div class="bottom" style="justify-content: space-around">
            ...
            <div class="resGroup">
              ...
              <div class="cont">
                ...
                <div class="num">{{ computationTime(scoreData.duration) }}</div>
              </div>
            </div>
          </div>
          <div class="chartBox">
              ...
              <div class="totalTable" v-show="showChart == 'total'">
                ...
                <template v-if="scoreData.deductInfo">
                  ...
                  <div class="row">
                    ...
                    <div class="item">{{ scoreData.deductInfo.errorCodeNumber }} 行</div>
                    <div class="item">{{ scoreData.deductInfo.errorCodeScore*1 }} 分</div>
                  </div>
                  <div class="row">
                    <div class="item lab full">多少行</div>
                    <div class="item">{{ scoreData.deductInfo.muchLessLineNumber }} 行</div>
                    <div class="item">{{ scoreData.deductInfo.muchLessLineScore*1 }} 分</div>
                  </div>
                  <div class="row">
                    <div class="item lab full">多少组</div>
                    <div class="item">{{ scoreData.deductInfo.muchLessGroupsNumber }} 组</div>
                    <div class="item">{{ scoreData.deductInfo.muchLessGroupsScore*1 }} 分</div>
                  </div>
                  <div class="row">
                    <div class="item lab full">多少码</div>
                    <div class="item">{{ scoreData.deductInfo.muchLessCodeNumber }} 组</div>
                    <div class="item">{{ scoreData.deductInfo.muchLessCodeScore*1 }} 分</div>
                  </div>
                  <div class="row">
                    <div class="item lab full">少回行</div>
                    <div class="item">{{ scoreData.deductInfo.lessReturnLineNumber }} 组</div>
                    <div class="item">{{ scoreData.deductInfo.lessReturnLineScore*1 }} 分</div>
                  </div>
                  <div class="row">
                    <div class="item lab full">少页标</div>
                    <div class="item">{{ scoreData.deductInfo.lessPageNumber }} 码</div>
                    <div class="item">{{ scoreData.deductInfo.lessPageScore*1 }} 分</div>
                  </div>
                  <div class="row">
                    <div class="item lab full">页标错</div>
                    <div class="item">{{ scoreData.deductInfo.errorPageNumber }} 码</div>
                    <div class="item">{{ scoreData.deductInfo.errorPageScore*1 }} 分</div>
                  </div>
                  <div class="row">
                    <div class="item lab full">不归</div>
                    <div class="item">{{ scoreData.deductInfo.nonStandartNumber }} 个</div>
                  ...
                  <div class="row">
                    ...
                    <div class="item">{{ scoreData.deductInfo.correctMistakesNumber }} 个</div>
        ...
        <div class="telegraphBox">
          ...
          <div style="height: 40%">
            <template v-if="testData.length>0">
              <a-textarea v-model:value="testData[page.current-1].value" disabled style="height: 100%; resize: none; word-spacing: 10px; border: 1px solid #384c77; background: #0a1936"></a-textarea>
            </template>
          </div>
        </div>
      </div>
...
<style scoped lang="less">
  ...
  @import "../../../../postJob/datagram/datagram/css/TrainScore";
