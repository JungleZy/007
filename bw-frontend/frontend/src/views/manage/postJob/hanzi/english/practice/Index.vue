  ...
  <div class="telexTrainBox content-mask-bg h-full w-full overflow-auto layout-left-top relative">
            ...
            <div class="basicInit" style="position: relative">
              <div class="item relative">
                ...
                <div>
                  ...
                  <div class="tags nobr">{{ trainData.correctNum * 1 }}个</div>
                </div>
              </div>
              <div class="item relative">
                ...
                <div>
                  ...
                  <div class="tags nobr">{{ trainData.errorNum * 1 }}个</div>
                </div>
              </div>
              <div class="item relative">
                <img :src="labCheck" class="ico" />
              ...
              <div class="item relative">
                ...
                <div>
                  ...
                  <div class="tags nobr">{{ trainData.speed * 1 }}词/分</div>
                </div>
              </div>
            </div>
          </div>
    ...
    >
      ...
      <div class="w-full layout-center" v-if="isfocus" style="padding: 40px 0; height: 330px">
        <div style="width: 50%; display: flex; height: 100%"></div>
      </div>
      <div class="w-full" :style="[isfocus ? 'height: calc(100% - 330px)' : 'height:100%']">
        <div
          class="w-full h-full layout-left-top scorebox"
          style="overflow: auto; max-height: max-content"
        >
          <WZTrain :message="message" :trainData="trainData"></WZTrain>
        </div>
      </div>
    </div>
