  ...
  <div class="w-full h-full bg">
    <div class="titleBg" style="display: flex;justify-content: center;overflow: hidden">
      ...
      <div class="h-full title2 layout-center">
        ...
        <div class="label label3 fs_dispose labelS">数据报拍发</div>
      </div>
...
const { uploadFileUrl, fileUrl, fileList, listData, active, addDrillModal, newKnowledge, clickTitle, openAddMainPoints, modifyMainPoints, deleteMainPoints, addMainPoints, clickMainPoints, handleChange, beforeUpload } = explain()
</script>
