  ...
  <div class="w-full h-full bg">
    <div class="titleBg" style="display: flex;justify-content: center;overflow: hidden">
      ...
      <div class="h-full title2 layout-center">
        ...
        <div class="label label3 fs_dispose" style="padding-left: 30px" :class="{labelS:activeS==0}" @click="labelClick(0)">收报基础</div>
        <div class="label label2 fs_dispose" :class="{labelS:activeS==1}" @click="labelClick(1)">情况处置</div>
        <div class="label label3 fs_dispose" style="padding-right: 30px" :class="{labelS:activeS==2}" @click="labelClick(2)">常见毛病和纠正方法</div>
      </div>
...
<!--      <div class="item_group btn layout-center" style="margin-top: 2px; margin-left: 8px" @click="next" v-if="route.query.text">-->
<!--        <IconFont type="icon-shanchu1" color="#f60" style="font-size: 16px; margin-right: 5px"></IconFont>-->
<!--        next-->
<!--      </div>-->
    </div>
