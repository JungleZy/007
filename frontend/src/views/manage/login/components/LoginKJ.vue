    ...
    <div class="h-full relative login layout-center" style="pointer-events: none">
      ...
      <div class="w-full layout-center relative inputs">
        <div class="w-full relative flex justify-center items-center flex-col  ">
          <img :src="lg" style="width:650px" />
          <img :src="lt" style="width: 1250px"  />


        </div>
        <div class="w-full content primary-color layout-center" style="pointer-events: auto;margin-top: 50px">
                  ...
                  <div class="w-full ">
                    <div style="display: flex">
                      <a-checkbox
                        ...
                        style="color: #e2d6b0; font-size: 14px"
                      >记住信息</a-checkbox
                      >
...
<script setup>
  ...
  import icoUser from '../../../../assets/KJ/login/input-user.png'
  import icoPwd from '../../../../assets/KJ/login/input-pwd.png'
  import lb from '../../../../assets/KJ/login/login-bg.png'
  import lm from '../../../../assets/KJ/login/login-mask.png'
  import lg from '../../../../assets/KJ/login/logo.png'
  import lt from '../../../../assets/KJ/login/login-title.png'
  //登录按钮
  import lu from '../../../../assets/KJ/login/staticButton.png'
  import staticButton from '../../../../assets/KJ/login/staticButton.png'
...
<style scoped>
  .cool .loginbg {
    background: url('../../../../assets/KJ/login/staticBG-hj.jpg');
  }
  .loginbg {
    background: url('../../../../assets/KJ/login/staticBG-hj.jpg');
  }
  ...
  .loginIpt {
    background: url('../../../../assets/KJ/login/login-mask.png') no-repeat;
    background-size: 100% 100%;
  }

  /*.ckBox .ant-checkbox-wrapper .ant-checkbox-checked .ant-checkbox-inner {*/
  /*  background: url('../../../../assets/KJ/login/ico-checkbox-checked-bg.png') !important;*/
  /*}*/
  ...
  .line {
    background: url('../../../../assets/KJ/login/line.png');
    height: 32px;
    width: 100%;
    max-width: 1187px;
    position: relative;
  ...
  .lineLight {
    position: absolute;
    top: 32px;
    background: url('../../../../assets/KJ/login/line-l.png');
    width: 186px;
    height: 11px;
    left: 35%;
    opacity: 0;
  ...
  .bg {
    background-image: url('../../../../assets/KJ/login/inputBG.png');
    background-size: 100% 100%;
    padding: 0px 15px;
    transition: all 1s;
    width: 406px;
