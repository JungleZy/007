    ...
    resetElectronKeyZuXunStatistics({trainId:trainId.value}).then(res => {
      if (res.code === 200) {
        ...
        chartData.value.column.val = [
          res.data.errorCollect.errorNumber,
          res.data.errorCollect.lackNumber,
          res.data.errorCollect.moreNumber,
          res.data.errorCollect.lackLineNumber,
          res.data.errorCollect.moreLineNumber,
          res.data.errorCollect.lackGroupNumber,
          res.data.errorCollect.moreGroupNumber,
        ]
